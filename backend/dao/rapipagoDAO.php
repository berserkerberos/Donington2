...
class rapipagoDAO extends DAOGeneric
{
    ...
    public function procesar($export)
    {
        ...
        $caracter_separador = "";
        $cod_rapipago = $export->getCodigoDePago();
        ...
        $sql = "
                    ...
                    SELECT  '5' AS TIPO_REG,
                            RIGHT(10000000000000000000 + SAPABAP1.VBRK.KUNAG,19) AS NRO_REF ,
                             RIGHT(CONCAT(10000000000000000000 , SAPABAP1.VBRK.XBLNR),20) AS IDEM_FACT,
        ...
        if (!$result){
            ...
            $resultadotxt .= "0" . $caracter_separador.
            $cod_rapipago .$caracter_separador.
            "00" .$caracter_separador.
            ...
            while ($row = odbc_fetch_object($result)){
                ...
                $resultadotxt .=  $row->TIPO_REG . $caracter_separador.
            ...
            "814" .$caracter_separador.
            "00" .$caracter_separador.
            $fecha_archivo .$caracter_separador.
            substr((10000000 + $cantidad_registros),-7) .$caracter_separador.
            "0000000" .  $caracter_separador.
            substr((100000000000 + $total_facturado),-11) .$caracter_separador.
            "00000000000" .  $caracter_separador.
            "0000000000000000000000000000000000000000" .  $caracter_separador;
        }
