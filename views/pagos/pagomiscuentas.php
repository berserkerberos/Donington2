...
<form action="exportaciones.php" id="form1" action="POST">
	...
	<input type="hidden" value="pagomiscuentas" id="tipo_export" name="tipo_export" >
    <div class="container">        

        <h1>Pagomiscuentas</h1>
        ...
        <div class="card" style="padding:15px">
            ...
            <div class="row">
                ...
                <div class="col-sm-3">
                    <label for="">Cod de pagomiscuentas</label>
                    <input type="number" name="txCod" class="form-control" >
                </div>
                
                <div class="col-sm-4">
                    <label for="">Concepto de facturas</label>
                    <input type="text" name="txConcepto" class="form-control" >
                </div>
